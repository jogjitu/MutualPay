...
public class AddContactsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Log.d("SelectedContact",contactsListView.getItemAtPosition(position).toString());
                intent.putExtra("com.catchblocker.mutualpay.Profile",
                        new Profile(contactsListView.getItemAtPosition(position).toString(),phoneNumbers.get(position)));
    ...
    public void fetchContacts() {
        ...
        if (cursor.getCount() > 0) {
            while (cursor.moveToNext()) {
                ...
                if (hasPhoneNumber > 0) {
                    ...
                    while (phoneCursor.moveToNext()) {
                        ...
                        //profile = new Profile(name,phoneNumber);
            ...
            ArrayAdapter<String> listAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, contactNames);
            contactsListView.setAdapter(listAdapter);
        }
        else{
            Log.d("No Contacts Found!!!","");
        }
